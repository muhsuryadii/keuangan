...
?>
<?php
if(isset($_POST['tambah-beban-toilet'])){
    ...
    $simpan = $koneksi->query("INSERT INTO beban_toilet (no_ppa, tgl, debet, kredit, uraian_kegiatan, tanda_bukti) values ('$_POST[no_ppa]','$_POST[tgl]','$_POST[debet]','$_POST[kredit]','$_POST[uraian_kegiatan]','$dirUpload')");
